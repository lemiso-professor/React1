    ...
    <div className="w-full flex justify-between h-14 items-center">
      <div className="h-full flex items-center gap-x-4 text-gray-700 dark:text-gray-300">
        <a href="tel:" className="flex gap-1 text-sm">
          ...
          <span className="hidden sm:flex">+254 97 24 44 966</span>
        </a>
        <a href="mailto:" className="flex gap-1 items-center">
          ...
          <span className="hidden sm:flex">Construction@info.com</span>
        </a>
      </div>
    ...
    <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 grid lg:grid-cols-2 lg:items-center gap-10">
      ...
      <div className="flex aspect-square lg:aspect-auto lg:h-[35rem] relative">
        <div className="w-3/5 h-[80%] rounded-3xl overflow-clip border-8 border-gray-200 dark:border-gray-950 z-30">
          <img src="/src/assets/1.2.avif" alt="buildind plan image" width={300} className="w-full h-full object-cover z-30" />
        </div>
        <div className="absolute right-0 bottom-0 h-[calc(100%-50px)] w-4/5 rounded-3xl overflow-clip border-4 border-gray-200 dark:border-gray-800 z-10">
          <img src="/src/assets/1.1.avif" alt="working-on-housing-project" width={300} className="z-10 w-full h-full object-cover" />
        </div>
      </div>
    </div>
  </section>
